...
Twirlip15 uses the approach of a trusted client which uses the equivalent of fopen and directory-related file commands sent from the UI across the network to a server. 
...
WARNING: Twirlip15 is currently alpha software and is only appropriate for us by advanced users who know about computer networking and software development.
